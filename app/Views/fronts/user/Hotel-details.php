                            ...
                            <div class="col-6">
                                <div class="position-relative rounded-2 overflow-hidden">
                                    ...
                                    <div class="position-absolute w-100 h-100 left-0 top-0 d-flex flex-center bg-black bg-opacity-50">
                                        <a class="text-white stretched-link" href="gallery.html">Show all</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-4">
                <div class="card mt-3 mt-xl-0">
                    <div class="card-body">
                        ...
                        <a class="btn btn-primary mt-3 w-100" href="checkout.html">Proceed with booking</a>
                    </div>
                </div>
            </div>
        </div>
